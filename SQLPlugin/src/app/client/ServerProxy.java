...
import app.definitions.CatanColor;
import app.definitions.LogLevel;
...
public interface ServerProxy
{
	...
	/**
	 * Returns the state of the game at the model number in JSON format. You must login and join a game before
	 * calling this method.
	 * 
