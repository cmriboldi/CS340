...
/**
 * The 'mock' proxy inherits all functions from the ServerProxy interface but will not be used for acutal communication purposes with the server.  
 * The mock proxy will be used only for testing purposes and will return hard coded replies. 
